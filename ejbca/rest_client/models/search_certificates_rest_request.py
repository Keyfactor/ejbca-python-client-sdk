...
T = TypeVar("T", bound="SearchCertificatesRestRequest")


@attr.s(auto_attribs=True)
class SearchCertificatesRestRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        search_certificates_rest_request = cls(
            max_number_of_results=max_number_of_results,
            criteria=criteria,
        )

        search_certificates_rest_request.additional_properties = d
        return search_certificates_rest_request
