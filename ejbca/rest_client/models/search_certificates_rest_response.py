...
T = TypeVar("T", bound="SearchCertificatesRestResponse")
...
class SearchCertificatesRestResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        search_certificates_rest_response = cls(
            certificates=certificates,
            more_results=more_results,
        )

        search_certificates_rest_response.additional_properties = d
        return search_certificates_rest_response
