...
from ...models.search_end_entities_rest_request import SearchEndEntitiesRestRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: SearchEndEntitiesRestRequest,
) -> Dict[str, Any]:
    url = "{}/v1/endentity/search".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    found below, under SearchEndEntityCriteriaRestRequest model.
