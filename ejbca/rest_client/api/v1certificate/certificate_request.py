...
from ...models.certificate_request_rest_request import CertificateRequestRestRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: CertificateRequestRestRequest,
) -> Dict[str, Any]:
    url = "{}/v1/certificate/certificaterequest".format(client.base_url)
